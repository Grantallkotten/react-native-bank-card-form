export const getBackgroundImage = (index: string): any => {
...
const backgroundImages: Record<string, any> = {
  ...
  '15': require('../assets/images/15.jpeg'),
  '16': require('../assets/images/16.jpeg'),
  '17': require('../assets/images/17.jpeg'),
  '18': require('../assets/images/18.jpeg'),
  '19': require('../assets/images/19.jpeg'),
  '20': require('../assets/images/20.jpeg'),
  '21': require('../assets/images/21.jpeg'),
};
